    ...
    for i, file in enumerate(files):
        if file.endswith('.csv'):
            ...
            if x < 0.8:
                ...
                shutil.copy(os.path.join(directory, 'images', os.path.splitext(file)[0] + '.jpg'), os.path.join(directory, 'train_dataset', os.path.splitext(file)[0] + '.jpg'))
            else:
                shutil.copy(os.path.join(directory, 'images', file), os.path.join(directory, 'val_dataset', file))
                shutil.copy(os.path.join(directory, 'images', os.path.splitext(file)[0] + '.jpg'), os.path.join(directory, 'val_dataset', os.path.splitext(file)[0] + '.jpg'))
