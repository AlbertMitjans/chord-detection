...
while True:
    ...
    np.savetxt('C:\\Users\\biomlearn\\Desktop\\yolo\\data\\custom\\labels\\image{num}_2.txt'.format(num=i), text, newline=' ', fmt='%.10f')

    if png:
        plt.imsave('C:\\Users\\biomlearn\\Desktop\\yolo\\data\\custom\\images\\image{num}_2.png'.format(num=i), img)
    if not png:
        plt.imsave(
            'C:\\Users\\biomlearn\\Desktop\\yolo\\data\\custom\\images\\image{num}_2.jpg'.format(num=i), img)
